  ...
  useEffect(() => {
    ...
    const fetchHoveringItemsForCause993 = async (causeName) => {
      try {
        ...
        const response = await fetch(`http://localhost:226/api/fetch_hoveringg_items_for_topcause?cause=${encodedCauseName}`);
      ...
      return (
        <tr
          ...
          style={{
            ...
            backgroundColor: isHoveredQuestion || isHoveredAnswer ? 'rgba(200, 200, 255, 0.5)' : 'transparent',
          }}
        >
          <td>
            <div>
