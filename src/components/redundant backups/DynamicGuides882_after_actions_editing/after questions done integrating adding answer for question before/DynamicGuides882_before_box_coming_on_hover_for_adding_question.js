    ...
    {data884 && data884.questions.map((question, index) => {
      ...
      return (
        <tr
          ...
          onMouseLeave={() => setHoveredRow(null)} // Reset when the mouse leaves the row
        >
          ...
          {/* <td></td> */}
                    ...
                    {/* Blank TD where the FaCog icon will appear on hover */}
                    <td style={{ position: 'relative', textAlign: 'center' }}>
            {hoveredRow === index && <FaCog style={{ cursor: 'pointer' }} />}
          </td>
