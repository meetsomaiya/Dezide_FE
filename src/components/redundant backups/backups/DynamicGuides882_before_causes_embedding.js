...
const [modalName, setModalName] = useState("");
  ...
  const handleFetchCause = async (causeName) => {
    try {
      ...
      // Handle the additional cause data as needed (e.g., display in modal or add to state)
    } catch (error) {
      console.error("Failed to fetch additional cause data:");
    }
  };        
