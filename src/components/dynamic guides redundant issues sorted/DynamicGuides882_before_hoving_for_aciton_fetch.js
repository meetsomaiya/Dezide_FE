    ...
    const fetchHoveringItemsForCause993 = async (causeName) => {
      try {
        ...
        setHoverItems894({
          ...
          questionAnswers: ["dummyanswers"],
        });
    
        console.log("State set to dummy values due to error:", {
          actions: ["dummyactions"],
          questions: ["dummyquestions"],
          questionAnswers: ["dummyanswers"],
        });
...
const addNewUntitledSubCause = (causeIndex, parentCauseName) => {
  ...
  let newCauseName = "Untitled SubCause"; // Default cause name
...
<div className="causes-header-container" ref={gearRef1112}>
    ...
    <table
  className="modal-table2"
  id="cause-table"
  onMouseLeave={() => {
    console.log("Mouse left the table, sending request with dummycause");
    fetchHoveringItemsForCause993("dummycause"); // Call with default value
  }}
>
  <thead>
    <tr>
  ...
  onMouseLeave={() => {
    ...
    console.log("Mouse left the table, sending request with dummycause");
    fetchHoveringItemsForCause993("dummycausemeet"); // Call with default value
  }}
  style={{
...
<tr
  // style={{
  //   backgroundColor: isHoveredQuestion || isHoveredAnswer || hoverItems894.causes.length > 0
