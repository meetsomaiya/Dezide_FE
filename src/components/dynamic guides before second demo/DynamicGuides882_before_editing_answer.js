      ...
      <table className="modal-table" id="question-table">
        ...
        <tbody>
          {data884 && data884.questions.map((question, index) => {
            // Check if the question name or answers are in hoverItems
            ...
            return (
              ...
              >
                ...
                //    handleQuestionAnswerClick(); // Toggle column visibility
                  }}
                >
                  ...
                  {expandedRow883 === index && (
  <>
    {questionAnswers885[index]?.length > 0 ? (
    ...
    <td colSpan="4">No answers available</td>
                ...
                <td style={{ position: "relative", textAlign: "center" }}>
                  {hoveredRow === index && (
                    <FaCog
                      style={{ cursor: "pointer" }}
                      onClick={(event) => handleIconClick903(index, event)} // Handle icon click
                    />
                  )}
                </td>
              </tr>
...
{clickedCell903 !== null && (
  ...
  >
    <div
      ...
      onClick={() => createAnswer903(clickedCell903, paginatedData990[clickedCell903]?.name || "Unknown")}
    >
      Create Answer
    </div>
  </div>
