  ...
  isModalOpen && (
    <div className="modal-overlay">
      <div className="modal-container">
        ...
        Causes
        <span
          className="create-top-cause"
          onClick={() => setIsCreateTopCauseInputVisible(!isCreateTopCauseInputVisible)}
        >
          *
        </span>
      </h3>
          ...
          {isCreateTopCauseInputVisible && (
            <tr>
              ...
              <td>
                <button
                  onClick={() => {
                    setCausesData([...causesData, newCause]);
                    setNewCause({ name: "", probability: 0 });
                  }}
                >
                  Add
                </button>
